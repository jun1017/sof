...
import sof.editor.shapes.model.commands.ShapeCreateCommand;
import sof.editor.shapes.model.commands.ShapeSetConstraintCommand;
...
private static class ShapesXYLayoutEditPolicy extends XYLayoutEditPolicy {
	...
	protected Command getCreateCommand(CreateRequest request) {
		...
		if (childClass == EllipticalShape.class || childClass == RectangularShape.class ||
		                childClass == BundleActivatorShape.class ||
		                childClass == ServiceListenerShape.class ||
		                childClass == ServiceShape.class) {
