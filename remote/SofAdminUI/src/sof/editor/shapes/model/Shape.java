 ...
 * @see sof.editor.shapes.model.examples.shapes.model.RectangularShape
 * @see sof.editor.shapes.model.examples.shapes.model.EllipticalShape
 * @author  
 */
...
// is not serializable
protected transient List<IPropertyDescriptor> propertyDescriptorList;
...
public Shape()
{
    this.propertyDescriptorList = new ArrayList<IPropertyDescriptor>();
    this.propertyDescriptorList.add( new TextPropertyDescriptor(XPOS_PROP, "X") );
    this.propertyDescriptorList.add( new TextPropertyDescriptor(YPOS_PROP, "Y") );
    this.propertyDescriptorList.add( new TextPropertyDescriptor(WIDTH_PROP, "Width") );
    this.propertyDescriptorList.add( new TextPropertyDescriptor(HEIGHT_PROP, "Height") );
    
    int size = this.propertyDescriptorList.size();
    
            // use a custom cell editor validator for all four array entries
            for (int i = 0; i < size; i++) {
                ((PropertyDescriptor) this.propertyDescriptorList.get( i ) ).setValidator(new ICellEditorValidator() {
...
public IPropertyDescriptor[] getPropertyDescriptors() {
	return this.propertyDescriptorList.toArray( new IPropertyDescriptor[this.propertyDescriptorList.size()] );
}
...
public Object getPropertyValue(Object propertyId) {
    System.out.println( "[Shape#getPropertyValue] Called, propertyId: " + propertyId );
...
public Dimension getSize() {
    System.out.println( "[Shape#getSize] Called.");
	return size.getCopy();
}
...
public void setPropertyValue(Object propertyId, Object value) {
    System.out.println( "[Shape#setPropertyValue] Called, propertyId: " + propertyId + ", value: " + value  );
	if (XPOS_PROP.equals(propertyId)) {
...
public void setSize(Dimension newSize) {
	if (newSize != null) {
	    System.out.println( "[Shape#setSize] Called, newSize: " + newSize );
